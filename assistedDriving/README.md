...
- Preferences: Lets users pick optional categories shown in Tutorial/Overview. Mandatory categories are always included: `aktivierung`, `deaktivierung`, `risiken`.
- Overview: Quick overview of all categories selected by the user (plus mandatory); paginated with progress dots and bookmarking.
...
## Key Features
- Customizable content: User-selected categories (stored as `preferences`) plus mandatory categories.
...
- public/
  - assets/
    ...
    - js/
      ...
      - preferences.js        # Preferences UI + save to API
